...
- [Pin Assignments](#pin-assignments)
    ...
    - [HSMC Expansion Header](#hsmc-expansion-header)
    - [24-Bit Audio Codec](#24-bit-audio-codec)
    - [I2C Bus](#i2c-bus)
    - [VGA](#vga)
    - [TV Decoder](#tv-decoder)
    - [IR Receiver](#ir-receiver)
    - [IR Emitter LED](#ir-emitter-led)
    - [SDRAM](#sdram)
    - [PS/2 Serial Port](#ps2-serial-port)
    - [ADC](#adc)
    - [Gigabit Ethernet](#gigabit-ethernet)
    - [UART Interface](#uart-interface)
    - [DDR3 Memory](#ddr3-memory)
    - [Micro SD Card Socket](#micro-sd-card-socket)
    - [2-Port USB Host](#2-port-usb-host)
    - [Accelerometer](#accelerometer)
    - [LTC Connector](#ltc-connector)
...
# set_location_assignment PIN_E23 -to I2C_SCLK
# set_location_assignment PIN_C24 -to I2C_SDAT
```
